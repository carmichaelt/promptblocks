  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'dark-md': '0 4px 6px -1px rgb(0 0 0 / 0.2), 0 2px 4px -2px rgb(0 0 0 / 0.2)',
        'dark-lg': '0 10px 15px -3px rgb(0 0 0 / 0.2), 0 4px 6px -4px rgb(0 0 0 / 0.2)',
        'dark-xl': '0 20px 25px -5px rgb(0 0 0 / 0.2), 0 8px 10px -6px rgb(0 0 0 / 0.2)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
